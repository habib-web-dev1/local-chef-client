  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-8">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden border dark:border-gray-700">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                  {meal.description ||
                    "A delicious homemade meal prepared with fresh ingredients and traditional cooking methods. Our chef takes pride in creating authentic flavors that will transport you to culinary heaven."}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
                    ...
                    <p className="text-gray-600 dark:text-gray-400">
                      {meal.estimatedDeliveryTime || "30-45 minutes"}
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white text-lg">
                      {meal.chefName || "Professional Chef"}
                    </h4>
                    <p className="text-gray-600 dark:text-gray-400">
                      Certified culinary expert with years of experience in
                      creating authentic, delicious meals.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="p-8 md:p-12 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-black text-gray-900 dark:text-white mb-4">
              You Might Also Like
            </h2>
            <p className="text-gray-600 dark:text-gray-400">
              Discover more delicious meals from our talented chefs
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Placeholder for related meals - in real app, fetch from API */}
            {[1, 2, 3].map((item) => (
              <div
                key={item}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                    Another delicious option from our chef collection
                  </p>
